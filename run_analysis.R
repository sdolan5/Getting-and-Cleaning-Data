...
##No.5- Create a second, independent tidy data set with the average of each variable 
...
# Merge the new table with activityType to reintroducedescriptive activity names
tidy_data <- merge(tidy_data,activityType,by='activityId',all.x=TRUE)

# Export the tidyData set 
write.table(tidy_data, "tidy_data2.txt", row.names=FALSE)